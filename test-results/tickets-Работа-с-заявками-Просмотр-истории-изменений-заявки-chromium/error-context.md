...
- Name: tickets.spec.ts >> Работа с заявками >> Просмотр истории изменений заявки
- Location: frontend\tests\e2e\tickets.spec.ts:159:3
  ...
  - generic [ref=e3]:
    ...
    - main [ref=e10]:
      - generic [ref=e11]:
        ...
        - generic [ref=e16]:
          - generic [ref=e17]:
            - textbox "Введите вашу почту" [active] [ref=e20]: test@example.com
            - button "Отправить код" [ref=e21] [cursor=pointer]:
              - generic [ref=e22]: Отправить код
          - paragraph [ref=e23]:
            - text: Нет аккаунта?
            - button "Зарегистрироваться" [ref=e24] [cursor=pointer]:
              - generic [ref=e25]: Зарегистрироваться
  - generic:
    - img
  - generic [ref=e26]:
