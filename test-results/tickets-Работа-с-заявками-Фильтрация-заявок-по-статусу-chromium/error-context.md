...
- Name: tickets.spec.ts >> Работа с заявками >> Фильтрация заявок по статусу
- Location: frontend\tests\e2e\tickets.spec.ts:140:3
      ...
      - generic [ref=e11]:
        ...
        - generic [ref=e16]:
          - generic [ref=e17]:
            - generic [ref=e18]:
              - generic [ref=e19]:
                - textbox "Введите вашу почту" [ref=e20]
                - generic [ref=e21]: "true"
              - generic [ref=e22]: Email обязателен для заполнения
